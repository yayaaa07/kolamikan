                    ...
                    <table class="table">
                        ...
                        <tbody> 
                            ...
                            <?php 
                                ...
                                if ($_GET['cari']) {
                                    $cari = $_GET['cari'];
                                    $sql = mysqli_query($con, "SELECT avg(format(suhu,2)) as suhu, avg(format(ketinggian,2)) as ketinggian, if(count(cuaca = 'hujan') > count(cuaca = 'tidak hujan'), 'Hujan', 'Tidak Hujan') as cuaca, LEFT(waktu, 10) as waktu FROM sensor WHERE LEFT(waktu, 10) = '$cari' GROUP BY LEFT(waktu, 10) ORDER BY waktu DESC LIMIT $hal_awal, $batas");
                                } else {
                                    $sql = mysqli_query($con, "SELECT avg(format(suhu,2)) as suhu, avg(format(ketinggian,2)) as ketinggian, if(count(cuaca = 'hujan') > count(cuaca = 'tidak hujan'), 'Hujan', 'Tidak Hujan') as cuaca, LEFT(waktu, 10) as waktu FROM sensor GROUP BY LEFT(waktu, 10) ORDER BY waktu DESC LIMIT $hal_awal, $batas");
                                }
